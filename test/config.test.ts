...
describe("lib schema", () => {
  it("invalid lib - wildcard in array", () => {
  ...
  it("invalid lib - invalid data string", () => {
    const parsed = AllowBlockListItemSchema.safeParse({
  ...
  it("invalid lib - invalid data in array", () => {
    const parsed = AllowBlockListItemSchema.safeParse({
      senderAddress: [
